...
[Swift-Kuery-ORM](https://github.com/Kitura-Next/Swift-Kuery-ORM) is an ORM, built on top of Swift-Kuery, which allows you to simplify the persistence of model objects with your server.
...
## Usage
This example demonstrates how to execute an SQL query using `Swift-Kuery` with the [Swift-Kuery-PostgreSQL](https://github.com/Kitura-Next/Swift-Kuery-PostgreSQL) plugin.
...
Add Swift-Kuery and your Kuery plugin, in this case Swift-Kuery-PostgreSQL, to the dependencies within your application's `Package.swift` file. Substitute `"x.x.x"` with the latest `Swift-Kuery` [release](https://github.com/Kitura-Next/Swift-Kuery/releases) and `"y.y.y"` with the latest plugin [release](https://github.com/Kitura-Next/Swift-Kuery-PostgreSQL/releases).

```swift
dependencies: [
    ...
    // Add this line
    .package(url: "https://github.com/Kitura-Next/Swift-Kuery.git", from: "x.x.x"),
    .package(url: "https://github.com/Kitura-Next/Swift-Kuery-PostgreSQL.git", from: "y.y.y"),
  ],
  targets: [
    .target(
      name: ...
...
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Swift-Kuery/index.html).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/Swift-Kuery/blob/master/LICENSE.txt).
